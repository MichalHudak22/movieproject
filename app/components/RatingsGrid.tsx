  ...
  return (
    <div className="max-w-7xl mx-auto mt-8">
      ...
      {ratings.some(r => r.type === 'movie') && (
        <div className="mb-12">
          <h2 className="text-lg md:text-xl lg:text-3xl text-gray-200 font-bold mb-4">Your Rated Movies</h2>
      ...
      {ratings.some(r => r.type === 'series') && (
        <div className="mb-12">
          <h2 className="text-lg md:text-xl lg:text-3xl text-gray-200 font-bold my-4">Your Rated Series</h2>
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 xl:grid-cols-7 gap-6">
            {renderCards('series')}
          </div>
        </div>
